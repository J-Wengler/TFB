...
def parse_data_coords(line_indices, coords_file, coords_file_max_length, full_str_length):
    ...
    out_dict = {}
    # print("Line Indices: " + str(line_indices))
    # print("Coor File: " + str(coords_file))
    # print("Coor File Max Length: " + str(coords_file_max_length))
    # print("Full String Length: " + str(full_str_length))
